#イメージとアノテーションのファイルパスをリスト化する関数を作成
...
from augmentation import Compose, ConvertColor, ConvertFromInts, ToAbsoluteCoords, PhotometricDistort, Expand, RandomBrightness, RandomSampleCrop, Resize, SubtractMeans, ToPercentCoords, RandomMirror
